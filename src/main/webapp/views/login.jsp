...
<t:pagelayout>
    ...
    <div class="login ">
        <div class="login__title ">
            ...
            <div class="login__title__sub">Using your username and password.</div>
        </div>
        ...
        <form method="post">
            <div class="row flex-nowrap form-group">
                ...
                <div class="col-9 pl-0 d-flex align-items-stretch ">
                    <input class="form-group--input " type="text" name="username" placeholder="DatMV1">
                    <span class="form-group--important">(*)</span>
                </div>
            </div>
            ...
            <div class="login__submit ">
                ...
                <div class="">
                    ...
                    <div>The field <span class="login--important">(*)</span> is required</div>
